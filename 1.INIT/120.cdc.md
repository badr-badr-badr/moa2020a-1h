...
### a. Maintenance du produit 
  ...
  De plus, l'utilisateur doit être prévenu par une notification 30 minutes avant chaque maintenance afin de pouvoir s'organiser si besoin.
...
### e. Installation du système
  L'application peut-être installée dans le Play Store (pour Android) et dans l'App Store (pour Apple). 
## 15. Sécurité
### a. Accès au système
  Seules les personnnes ayant matchées peuvent accéder au profil complet respectif de l'autre personne. Chaque utilisateur peut choisir quelle information il veut ou non laisser visible pour un utilisateur lambda ou pour un match.
### b. Intégrité
